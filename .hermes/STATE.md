...
- **Фиксы СП52 (A.1-A.3, B.1-B.2) реализованы и закоммичены (2026-08-22):** цепочка architect (t_de63f7f5) → coder (t_9187901b) → review CHANGES_REQUESTED (t_50b6c220) → rework (t_1683d444) → повторная самопроверка orchestrator'ом нашла остаточный false-stitch в A.3 → rework #2 (t_5fbb2ba0) закрыл его. Подтверждено самостоятельно: py_compile OK, 25/25 целевых тестов (включая новый regression на false-stitch), полный набор 369 passed / 3 pre-existing RAG/reg failures (T17 больше не в списке). Следующий шаг — повторный review, затем живой прогон СП52 (проверка склейки Таблицы 4.1 в цепь из 4 частей + отсутствие потери данных в Таблице 7.1) и регрессия СП89/ГОСТ18410.

## Planned / backlog

- Живой прогон СП52 + регрессия СП89/ГОСТ18410 после закоммиченных фиксов A.1-A.3/B.1-B.2 (см. Recent decisions) — не выполнен, требует внешних OCR/AI credentials в среде coder-воркера.
