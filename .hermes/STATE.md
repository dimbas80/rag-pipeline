...
- **t_9187901b (coder)** — реализация фиксов по отчёту архитектора `t_de63f7f5`: A.1–A.3 (склейка Таблицы 4.1) + B.1–B.3 (loss-safe guard таблиц после AI + нормализация LaTeX + ужесточение промпта). Дальше — reviewer → живой прогон СП52 + регрессия СП89/ГОСТ18410.
