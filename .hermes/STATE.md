...
- **Вернуть vision/config_ai.yaml проекта на provod** (provod восстановлен 2026-08-22): ранее vision был переведён `provod → anymodel` (коммит `0d36607`) из-за недоступности provod. Теперь проверить и вернуть при необходимости — отдельная задача, не связана с диагностикой СП52.
