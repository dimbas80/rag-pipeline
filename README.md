...
2. Получить API-ключ (и ID каталога `folder_id`). Для аутентификации в AI Studio необходим идентификатор каталога. Чтобы его получить, в интерфейсе AI Studio наведите указатель на название каталога, расположенного в верхней части экрана, и нажмите . Идентификатор будет скопирован в буфер обмена.
